//HAMBURGER
        ...
        function changeLanguage() {
            if (isEnglish) {
                ...
                $(".aboutText p").text("Hi everyone, my name is Pawel Wedrowski and I am 22 years old. For four months I am developing my front-end skills. I am looking for a job or an internship in Warsaw. I enjoy learning new technologies and can assimilate with new ideas quickly. Apart from improving front-end skills I am getting familiar with back end technologies - currently Node.js. I am a true game lover and in the future I want ot take part in creating them. Besides that, I run a healthy lifestyle and enjoy Netflix and chill.");
                // section skills
